...
# Адрес бота
[@pvv_aiogram_bot](https://t.me/pvv_aiogram_bot) - после отправки /start необходимо немного подождать, чтобы бот запустился на сервере для прохождения клиентского пути со стороны "известного" пользователя можно использовать id 1010
