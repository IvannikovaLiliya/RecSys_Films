...
В итоге реализовано 5 ручек, с механикой конечного автомата для запоминания, что вводил пользователь.
...
# Для запуска бота необходимо запустить файл main.py из папки tg.bot