...
- old_vaseline - первые наработки по подготовке данных для обучения моделей и первые приближения по построению
- recsyc_part1 - финальные модели + класс для tg-бота, построенные в рамках проекта (к 14/01/24)
